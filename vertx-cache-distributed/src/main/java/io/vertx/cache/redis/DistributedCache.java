...
public interface DistributedCache extends Cache {
     ...
     */
    static Cache create(Vertx vertx) {
     ...
     */
    static Cache create(Vertx vertx, DistributedCacheOptions options) {
     ...
     */
    static Cache create(Vertx vertx, Redis redis, DistributedCacheOptions options) {
